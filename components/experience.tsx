...
export default function ExperienceCard({
  ...
  return (
    ...
    >
      <Card className="transition-all duration-300 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 border-l-4 border-l-teal-600 dark:border-l-teal-500 overflow-hidden relative">
        ...
        <CardHeader className="pb-2 relative z-10">
          <div className="flex justify-between items-start">
            <CardTitle className="text-xl text-teal-900 dark:text-teal-300 group-hover:text-teal-700 dark:group-hover:text-teal-200 transition-colors">
              {role}
            </CardTitle>
            <ArrowRight className="h-4 w-4 text-teal-600 dark:text-teal-300 opacity-0 group-hover:opacity-100 transition-opacity" />
          </div>
          <CardDescription className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mt-1">
            <div className="flex items-center gap-1">
              ...
              <span className="text-teal-900 dark:text-teal-200">{company}</span>
            </div>
            <div className="flex items-center gap-1">
              <Calendar className="h-4 w-4 text-teal-700 dark:text-teal-300" />
              <span className="text-teal-900 dark:text-teal-200">{period}</span>
            </div>
          </CardDescription>
        </CardHeader>
